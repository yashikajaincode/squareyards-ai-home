...
const MUST_HAVE_CATEGORY: Array<{ re: RegExp; cat: string }> = [
  ...
  { re: /rug/i, cat: "Rug" },
  { re: /pendant/i, cat: "Pendant Light" },
  { re: /task light|table lamp/i, cat: "Table Lamp" },
  { re: /lighting|floor lamp|lamp/i, cat: "Floor Lamp" },
  { re: /bed\b|queen bed|king bed|headboard/i, cat: "Bed" },
  { re: /wardrobe/i, cat: "Wardrobe" },
  { re: /nightstand|bedside/i, cat: "Bedside Table" },
  ...
  { re: /accent seating|accent chair|reading corner|lounger|armchair|wingback/i, cat: "Armchair" },
  { re: /curtain|drape/i, cat: "Curtains" },
  { re: /storage/i, cat: "Wardrobe" },
